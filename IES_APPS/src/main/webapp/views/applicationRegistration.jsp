...
<form:form action="register" method="post" modelAttribute="cum" style="max-width:500px;margin:auto">
  <div class="container">
    <font color="#4CAF50"><h1 align="center" ><u> Application Registration</u> </h1></font>
<form:hidden path="citizenId"/>
   ...
   <form:input path="firstName" />
    ...
    <form:input path="ssn"   maxlength="9"/>
